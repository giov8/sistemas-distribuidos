...
Arquivo: tempo.c
Modificado em 11/12/2020
Descrição:
Implementação relativa a Tarefa 1 do primeiro trabalho prático de sistemas distribuídos.
Os processos testarão  próximo processo e será impresso na tela o status do testado.
*/
